...
async function initData() {
  ...
  // Printknop – zet datum, geldigheidstekst, en print
...
(function installButtonManager() {
  ...
  async function detectInstalledRelatedApps() {
    try { if (!navigator.getInstalledRelatedApps) return false; const related = await navigator.getInstalledRelatedApps(); return Array.isArray(related) && related.length > 0; } catch { return false; }
  }
